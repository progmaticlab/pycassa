...
class CfDef(object):
  ...
  def write(self, oprot):
    ...
    if self.compaction_strategy_options is not None:
      ...
      for kiter102,viter103 in list(self.compaction_strategy_options.items()):
    ...
    if self.compression_options is not None:
      ...
      for kiter104,viter105 in list(self.compression_options.items()):
...
class KsDef(object):
  ...
  def write(self, oprot):
    ...
    if self.strategy_options is not None:
      ...
      for kiter119,viter120 in list(self.strategy_options.items()):
...
class CqlMetadata(object):
  ...
  def write(self, oprot):
    ...
    if self.name_types is not None:
      ...
      for kiter143,viter144 in list(self.name_types.items()):
    ...
    if self.value_types is not None:
      ...
      for kiter145,viter146 in list(self.value_types.items()):
